  ...
  return (
    <div className='w-35 shadow border border-dark-subtle m-4 card-har'>
        ...
        <div className='container'>
            ...
            <p className='fw-light fst-italic lh-sm'>{description.substring(0,19)}...<Link to={link} className='text-decoration-none fw-medium fst-italic m-2'>Read More</Link></p>
            <hr className='m-0'/>
