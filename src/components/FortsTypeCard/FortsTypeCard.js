  ...
  return (
    <div className='w-35 shadow border border-dark-subtle text-centerrounded m-4 card-col'>
        ...
        <div className='container'>
            ...
            <p className='fw-light fst-italic lh-sm'>{description.substring(0,111)}...<Link to={link} className='text-decoration-none fw-medium fst-italic m-2'>Read More</Link></p>
            <hr className='m-0'/>
            <div className='my-3 mb-3 fs-5 d-flex justify-content-between'>
                <button className='border py-1 w-50 rounded me-1'>
                <Link to={link} className="text-black text-decoration-none link">Learn more</Link></button>
