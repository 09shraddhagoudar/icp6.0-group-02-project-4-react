...
function Contact() {
  return (
    <div>
        ...
        <p className='location'>+91 8010564312</p>
        </div>
        <div className="contact-card">
        ...
        <p className='location'>84, Fortress Tours,Laksmi narayan chowk ,opposite narayan residency, ward no 3 , prasad colony, Nagpur-441108</p>
        </div>
        <Footer />
    </div>
  )
